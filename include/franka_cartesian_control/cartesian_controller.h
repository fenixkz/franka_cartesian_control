...
class CartesianPoseTactile
 ...
 public:
  ...
  bool response(franka_cartesian_control::Delta::Request& req, franka_cartesian_control::Delta::Response& res);
  double quintic(double ref, double r_, ros::Duration time, double dt);
 private:
